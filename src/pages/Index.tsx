        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ми — команда професіоналів, що вже понад 5 років займається брендуванням та виробництвом мерчу. Використовуємо DTF-технології у власних товарах і маємо величезний досвід у цій сфері, особливо в DTF-друку.
            </p>
          </div>
